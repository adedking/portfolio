...
function SignupFormTwo({ signUp, setUsername, setName, setConfirmPassword, setPassword }) {
    ...
    return (
        <div>
            <form onSubmit={signUp} className="signup-two-form">
                <p className="login-header-two">Sign Up</p>
                ...
                <div className="login-button-group">
                    <button type="submit" className="submit-button login-button-two">Sign Up</button>
                </div>
                <div className="signup-forgot">
                    <div className="signup">ALREADY HAVE AN ACCOUNT?<Link to="/login-two" className="signup-login"> LOGIN</Link></div>
                </div>
            </form>
        </div>
    )
...
export default withRouter(SignupFormTwo)
